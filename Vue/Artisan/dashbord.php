                    ...
                    <div class="container"><br>
                        <center>
                            ...
                            <div style="display: flex;justify-content:center">
                                <a href="https://Wa.me/+225<?php echo $only_user['phone_wa']; ?>" style="display:block;width:50px;height:50px;color:green" target="_blank">
                                ...
                                <a href="tel:+225<?php echo $only_user['phone_number']; ?>" style="display:block;width:50px;height:50px;color:black" target="_blank">
                            ...
                            <a href="edit_profil.php?id=<?php echo $only_user['id_artisan']; ?>" class="btn btn-primary">Modifier mes informations</a>
                        </center>
                    </div>
                </div>
