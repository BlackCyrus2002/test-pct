                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nom" id="nom" aria-describedby="helpId"
                                placeholder="" value="<?php echo $only_user['nom'] ?>" />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="phone_number" id="phone_number"
                                ...
                                value="<?php echo $only_user['phone_number'] ?>" />
                            <span style="color: red;font-size:18px">
                            </span>
                        </div>
                        <div class="mb-3">
                            <label for="phone_wa" class="form-label">Numéro WhattsApp</label>
                            <input type="number" class="form-control" name="phone_wa" id="phone_wa"
                                aria-describedby="helpId" placeholder="" value="<?php echo $only_user['phone_wa'] ?>" />
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="text" class="form-control" name="email" id="email" aria-describedby="helpId"
                                placeholder="" value="<?php echo $only_user['email'] ?>" />
                            <span style="color: red;font-size:18px">
                                <?php
                                echo $email_error
                                ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="path_photo" id="path_photo"
                                aria-describedby="helpId" onchange="previewImage(event)" />
                            <span style="color: red;font-size:18px">
                                <?php
                                echo $photo_user
                                ?>
